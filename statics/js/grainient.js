/**
 * Grainient Component - WebGL Animated Gradient with Noise and Warp Effects
 * Vanilla JavaScript version for Flask/HTML templates
 * 
 * Usage:
 * <div id="grainient-bg" style="width: 100%; height: 600px; position: relative;"></div>
 * <script>
...
class Grainient {
  ...
  init() {
    ...
    if (typeof OGL === 'undefined') {
      console.error('Grainient: OGL library not loaded');
      return;
    }
  ...
  fragColor=o;
    ...
    this.program = new Program(gl, {
      ...
      uniforms: {
        ...
        uColor1: { value: new Float32Array(this.hexToRgb(this.options.color1)) },
        uColor2: { value: new Float32Array(this.hexToRgb(this.options.color2)) },
        uColor3: { value: new Float32Array(this.hexToRgb(this.options.color3)) }
      }
    });
